...
<header>
	...
	<form method="post" action="item/edit">
		<div class="container">
			...
			<br>
				<input type="text" placeholder="Enter Type" name="name" id="name" required value="<%=request.getAttribute("itemname") %>">
			<br>
				<label for="name"><b>Category</b></label>
			<br>
				<select name="category_id" id="category_id" class="selectcat">
				  <c:forEach items="<%=(ArrayList<Category>)request.getAttribute(\"categories\") %>" var="category" varStatus="loop">
				    <option
				    	value="${category.id}"
				    	${category.id == itemcategory_id ? 'selected="selected"' : ''}
				    >
				        ${category.type}
				    </option>
				  </c:forEach>
			...
			<br>
				<input type="text" placeholder="Enter Type" name="quantity" id="quantity" required value="<%=request.getAttribute("itemquantity") %>">
			<br>
				<label for="name"><b>Price</b></label>
			<br>
				<input type="text" placeholder="Enter Type" name="price" id="price" required value="<%=request.getAttribute("itemprice") %>">
			<br>
				<label for="name"><b>Expiry</b></label>
			<br>
				<input type="date" placeholder="Enter Type" name="expiry" id="expiry" required value="<%=request.getAttribute("itemexpiry") %>">
			<br>
			<hr>
			<input type="hidden" id="id" name="id" value="<%=request.getAttribute("itemid") %>" />
