...
<header>
		<div class="mainnav">
			...
			<a class="active" href="<%=request.getContextPath()%>/category/list">Categories</a>
			<%
				if (role.equals("MANAGER")) {
	...
	<form method="post" action="category/create">
		<div class="container">
			...
			<hr>
			<label for="name"><b>Type</b></label> <br> <input type="text"
				placeholder="Enter Type" name="type" id="type" required> <br>
			<hr>
