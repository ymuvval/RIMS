...
<header>
	...
	<form method="post" action="shift/edit">
		<div class="container">
			<h1>Edit Request Shift</h1>
			<hr>
				<select name="new_shift" id="new_shift">
				  <option
				    	value="MORNING"
				    	${param.shiftreq == 'MORNING' ? 'selected="selected"' : ''}
				    >
				        MORNING
				  </option>
				  <option
				    	value="AFTERNOON"
				    	${param.shiftreq == 'AFTERNOON' ? 'selected="selected"' : ''}
				    >
				        AFTERNOON
				  </option>
		    	<option
			    	value="EVENING"
			    	${param.shiftreq == 'EVENING' ? 'selected="selected"' : ''}
			    >
			        EVENING
			  	</option>
		    	<option
			    	value="NIGHT"
			    	${param.shiftreq == 'NIGHT' ? 'selected="selected"' : ''}
			    >
			        NIGHT
			  	</option>
				</select>
